...
//     let quantity = 0;
//     const values = Object.values(products); //створення масиву значень властивостей products
//     for (const value of values) {   //перебір властивостей масиву 
//         quantity += value;  //додавання об'єму кожного продукту
//     }
//     return quantity <= containerSize;  //перевірка, чи помістяться всі товари в контейнер, та повернення
// }
